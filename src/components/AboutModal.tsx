...
export function AboutModal({ isOpen, onClose }: AboutModalProps) {
  ...
  return (
    <dialog
      ...
      className="m-auto w-full max-w-lg rounded-2xl bg-white p-0 text-slate-800 shadow-2xl border border-slate-200/80 backdrop:bg-slate-900/50 backdrop:backdrop-blur-xs transition-all duration-200 animate-in fade-in zoom-in-95"
      aria-labelledby="about-dialog-title"
    >
      <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
        <div className="flex items-center gap-2">
          <ShieldCheck className="w-5 h-5 text-indigo-600" />
          <h2 id="about-dialog-title" className="text-lg font-semibold text-slate-900">
        ...
        <div className="rounded-xl bg-slate-50 p-4 border border-slate-100">
          <p className="font-medium text-slate-900">
            ...
            <a
              ...
              className="inline-flex items-center gap-1 font-mono text-xs font-semibold text-indigo-600 hover:text-indigo-800 underline underline-offset-2"
            >
              {gitInfo.shortSha}
          ...
          <p className="mt-1 text-xs text-slate-500">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium text-slate-700 hover:text-indigo-600 underline underline-offset-2"
            >
              Loïc Viennois
            </a>
          </p>
          ...
          <ul className="mt-3 space-y-2">
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-slate-700 hover:bg-slate-100 hover:text-indigo-600 transition-colors"
              >
            ...
            <li>
              <a
                ...
                className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-slate-700 hover:bg-slate-100 hover:text-indigo-600 transition-colors"
              >
                <RedditIcon className="w-4 h-4 text-orange-600" />
